...
import VCSANavigationHeaderButtonStyle from './VCSANavigationHeaderButtonStyle';
import config from '../../config';
import { Text, useTheme } from 'react-native-paper';

export interface VCSANavigationHeaderButtonProps {
...
const VCSANavigationHeaderButton = (props: VCSANavigationHeaderButtonProps): JSX.Element => {
  ...
  const {
    ...
    count,
    textAccessory,
  } = VCSANavigationHeaderButtonStyle(theme);
...
export default VCSANavigationHeaderButton;
